...
# Code inputs only. Authored scientific docs/ has its own source/build ownership;
# linking a report does not authorize adding that tree to this generator.
SOURCE_DIRS = ['src-local', 'simulationCases', 'postProcess', 'testCases']
